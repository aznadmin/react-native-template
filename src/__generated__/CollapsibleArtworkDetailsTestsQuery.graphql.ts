/**
 * @generated SignedSource<<26db007dc234a1a0d5e2a46219ed529b>>
...
// @relayRequestID d761eeff945579e4683a3915d26544eb

import { ConcreteRequest, Query } from 'relay-runtime';
import { FragmentRefs } from "relay-runtime";
export type CollapsibleArtworkDetailsTestsQuery$variables = Record<PropertyKey, never>;
export type CollapsibleArtworkDetailsTestsQuery$data = {
  readonly artwork: {
    readonly " $fragmentSpreads": FragmentRefs<"CollapsibleArtworkDetails_artwork">;
  } | null | undefined;
};
export type CollapsibleArtworkDetailsTestsQuery = {
  response: CollapsibleArtworkDetailsTestsQuery$data;
  variables: CollapsibleArtworkDetailsTestsQuery$variables;
};
