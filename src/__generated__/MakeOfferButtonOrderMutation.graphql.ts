/**
 * @generated SignedSource<<3194db50beb62ec4431a5ac80082fa20>>
...
// @relayRequestID e9ace281deea637ec868fe49043633f2
...
export type MakeOfferButtonOrderMutation$variables = {
  input: CommerceCreateOfferOrderWithArtworkInput;
};
export type MakeOfferButtonOrderMutation$data = {
...
export type MakeOfferButtonOrderMutation = {
  response: MakeOfferButtonOrderMutation$data;
  variables: MakeOfferButtonOrderMutation$variables;
};
