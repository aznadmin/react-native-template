/**
 * @generated SignedSource<<8c255a21e28de0f7e57f0b4d7ded12c3>>
 * @relayHash aab47931982523846ff0fc539e9545ab
...
// @relayRequestID aab47931982523846ff0fc539e9545ab
...
export type ArtistAboveTheFoldQuery$data = {
  readonly artist: {
    ...
    readonly " $fragmentSpreads": FragmentRefs<"ArtistArtworks_artist" | "ArtistHeaderNavRight_artist" | "ArtistHeader_artist">;
  } | null | undefined;
};
export type ArtistAboveTheFoldQuery = {
  response: ArtistAboveTheFoldQuery$data;
  variables: ArtistAboveTheFoldQuery$variables;
};
...
return {
  ...
  "params": {
    "id": "aab47931982523846ff0fc539e9545ab",
    "metadata": {},
    "name": "ArtistAboveTheFoldQuery",
    "operationKind": "query",
    "text": null
...
(node as any).hash = "26f25a859db3880731fb8280ab6e9b9e";
