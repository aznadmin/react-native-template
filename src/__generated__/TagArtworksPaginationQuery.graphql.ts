/**
 * @generated SignedSource<<6cc94b7390e3544e0eb44452759c0fe2>>
 * @relayHash 0b0a331eddb517dcf80d683d2108c9ed
...
// @relayRequestID 0b0a331eddb517dcf80d683d2108c9ed
...
export type TagArtworksPaginationQuery$variables = {
  count: number;
  cursor?: string | null | undefined;
  id: string;
  input?: FilterArtworksInput | null | undefined;
};
export type TagArtworksPaginationQuery$data = {
  readonly tag: {
    readonly " $fragmentSpreads": FragmentRefs<"TagArtworks_tag">;
  } | null | undefined;
};
export type TagArtworksPaginationQuery = {
  response: TagArtworksPaginationQuery$data;
  variables: TagArtworksPaginationQuery$variables;
};
...
return {
  ...
  "params": {
    "id": "0b0a331eddb517dcf80d683d2108c9ed",
    "metadata": {},
    "name": "TagArtworksPaginationQuery",
    "operationKind": "query",
    "text": null
