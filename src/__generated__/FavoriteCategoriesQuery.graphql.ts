/**
 * @generated SignedSource<<8d99d56f4bd0d4d7337a7912367435cb>>
...
// @relayRequestID 1f2fe351db671db305e2398c685053b7

import { ConcreteRequest, Query } from 'relay-runtime';
import { FragmentRefs } from "relay-runtime";
export type FavoriteCategoriesQuery$variables = Record<PropertyKey, never>;
export type FavoriteCategoriesQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"FavoriteCategories_me">;
  } | null | undefined;
};
export type FavoriteCategoriesQuery = {
  response: FavoriteCategoriesQuery$data;
  variables: FavoriteCategoriesQuery$variables;
};
