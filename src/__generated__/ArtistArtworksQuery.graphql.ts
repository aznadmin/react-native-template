/**
 * @generated SignedSource<<ade1ecb4c2a9697623a70105b4483f60>>
 * @relayHash b3a6f0c528ace2be88674886c4942673
...
// @relayRequestID b3a6f0c528ace2be88674886c4942673
...
export type ArtistArtworksQuery$variables = {
  count: number;
  cursor?: string | null | undefined;
  id: string;
  input?: FilterArtworksInput | null | undefined;
};
export type ArtistArtworksQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistArtworks_artist">;
  } | null | undefined;
};
export type ArtistArtworksQuery = {
  response: ArtistArtworksQuery$data;
  variables: ArtistArtworksQuery$variables;
};
...
return {
  ...
  "params": {
    "id": "b3a6f0c528ace2be88674886c4942673",
    "metadata": {},
    "name": "ArtistArtworksQuery",
    "operationKind": "query",
    "text": null
