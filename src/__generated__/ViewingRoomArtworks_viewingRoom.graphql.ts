/**
 * @generated SignedSource<<afef48353be5d5a459fed32d9aff0afa>>
...
export type ViewingRoomArtworks_viewingRoom$data = {
  ...
  readonly internalID: string;
  readonly slug: string;
  readonly " $fragmentType": "ViewingRoomArtworks_viewingRoom";
};
