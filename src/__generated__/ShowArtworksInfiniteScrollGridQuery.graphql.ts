/**
 * @generated SignedSource<<63a0284162f1a4a7a5b0e5f81c013959>>
 * @relayHash 8abd580ed970a82ed31463e2a832c934
...
// @relayRequestID 8abd580ed970a82ed31463e2a832c934
...
export type ShowArtworksInfiniteScrollGridQuery$variables = {
  count: number;
  cursor?: string | null | undefined;
  id: string;
  input?: FilterArtworksInput | null | undefined;
};
export type ShowArtworksInfiniteScrollGridQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"ShowArtworks_show">;
  } | null | undefined;
};
export type ShowArtworksInfiniteScrollGridQuery = {
  response: ShowArtworksInfiniteScrollGridQuery$data;
  variables: ShowArtworksInfiniteScrollGridQuery$variables;
};
...
return {
  ...
  "params": {
    "id": "8abd580ed970a82ed31463e2a832c934",
    "metadata": {},
    "name": "ShowArtworksInfiniteScrollGridQuery",
    "operationKind": "query",
    "text": null
