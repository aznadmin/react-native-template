/**
 * @generated SignedSource<<05276cb146ec9b8f2fbe142a883e8e1a>>
 * @relayHash 1ae6dba4b053068a370c8680cbf1f710
...
// @relayRequestID 1ae6dba4b053068a370c8680cbf1f710
...
export type PartnerArtworkInfiniteScrollGridQuery$variables = {
  count: number;
  cursor?: string | null | undefined;
  id: string;
  input?: FilterArtworksInput | null | undefined;
};
export type PartnerArtworkInfiniteScrollGridQuery$data = {
  readonly partner: {
    readonly " $fragmentSpreads": FragmentRefs<"PartnerArtwork_partner">;
  } | null | undefined;
};
export type PartnerArtworkInfiniteScrollGridQuery = {
  response: PartnerArtworkInfiniteScrollGridQuery$data;
  variables: PartnerArtworkInfiniteScrollGridQuery$variables;
};
...
return {
  ...
  "params": {
    "id": "1ae6dba4b053068a370c8680cbf1f710",
    "metadata": {},
    "name": "PartnerArtworkInfiniteScrollGridQuery",
    "operationKind": "query",
    "text": null
