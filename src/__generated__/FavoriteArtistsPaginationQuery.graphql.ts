/**
 * @generated SignedSource<<0648a6a2d134c0bdf754ace7fc0a82e7>>
...
// @relayRequestID c66c8a7bf05200ee0e3bbf7b6686e495

import { ConcreteRequest, Query } from 'relay-runtime';
import { FragmentRefs } from "relay-runtime";
export type FavoriteArtistsPaginationQuery$variables = {
  count: number;
  cursor?: string | null | undefined;
};
export type FavoriteArtistsPaginationQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"FavoriteArtists_me">;
  } | null | undefined;
};
export type FavoriteArtistsPaginationQuery = {
  response: FavoriteArtistsPaginationQuery$data;
  variables: FavoriteArtistsPaginationQuery$variables;
};
