/**
 * @generated SignedSource<<12102114f1ed63a87467ff2178de880b>>
...
export type GeneArtworks_gene$data = {
  readonly artworks: {
  ...
  readonly slug: string;
  readonly " $fragmentType": "GeneArtworks_gene";
};
export type GeneArtworks_gene$key = {
  readonly " $data"?: GeneArtworks_gene$data;
  readonly " $fragmentSpreads": FragmentRefs<"GeneArtworks_gene">;
};
...
(node as any).hash = "bcf50a949af3602d3ffbb16f14a4d88f";
