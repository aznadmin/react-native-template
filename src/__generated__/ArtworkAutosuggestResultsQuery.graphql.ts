/**
 * @generated SignedSource<<33a57fd8d402f43666a096ef6d670611>>
 * @relayHash a76d93825a409279eed87533feccc9bd
...
// @relayRequestID a76d93825a409279eed87533feccc9bd
...
export type ArtworkAutosuggestResultsQuery$variables = {
  count: number;
  cursor?: string | null | undefined;
  input?: FilterArtworksInput | null | undefined;
  keyword?: string | null | undefined;
};
export type ArtworkAutosuggestResultsQuery$data = {
  readonly viewer: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtworkAutosuggestResults_viewer">;
  } | null | undefined;
};
export type ArtworkAutosuggestResultsQuery = {
  response: ArtworkAutosuggestResultsQuery$data;
  variables: ArtworkAutosuggestResultsQuery$variables;
};
...
return {
  ...
  "params": {
    "id": "a76d93825a409279eed87533feccc9bd",
    "metadata": {},
    "name": "ArtworkAutosuggestResultsQuery",
    "operationKind": "query",
    "text": null
